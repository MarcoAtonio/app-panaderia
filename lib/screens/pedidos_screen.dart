...
class _PedidosScreenState extends State<PedidosScreen> {
  ...
  // Filtrar los pedidos basados en la búsqueda
  List<Map<String, dynamic>> get _filteredPedidos {
    final searchText = _searchController.text.toLowerCase();
    return _pedidos
        .where((pedido) =>
    pedido['id'].toString().contains(searchText) ||
        pedido['pedido'].toLowerCase().contains(searchText))
        .toList();
  }
  ...
  List<Map<String, dynamic>> get _paginatedPedidos {
    ...
    return _filteredPedidos.sublist(startIndex,
        endIndex > _filteredPedidos.length
            ? _filteredPedidos.length
            : endIndex);
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/Fondosregistros.png',
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                            'Página $_currentPage de ${(_filteredPedidos
                                .length / _itemsPerPage).ceil()}'),
                        IconButton(
                          onPressed: _currentPage <
                              (_filteredPedidos.length / _itemsPerPage).ceil()
                              ? () {
                            setState(() {
                              _currentPage++;
                            });
